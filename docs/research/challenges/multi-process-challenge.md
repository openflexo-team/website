...
Get a current 2.99 build from the [Downloads page](/downloads) (the specific dated snapshot this
page used to point at is long gone — the download server only retains dated builds from 2024
onward).
...
Get a 2.0.1 build from the [Downloads page](/downloads) (same caveat as above — the original dated
