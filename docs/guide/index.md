...
sidebar_position: 1
title: User guide
description: What a virtual model is, how to write FML for it, and the recipes and tutorials that go with it.
---

# User guide

This section is for building and using a virtual model: the concepts behind it, the language that
