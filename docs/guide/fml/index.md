...
- [Annotations](/docs/guide/fml/annotations) covers how annotations are written and kept, which ones
  the platform reads, and how a technology adapter defines its own.
- [FML-script](/docs/guide/fml/fml-script) covers driving the runtime from a script: loading
  resources, instantiating models, asserting values, and its traps.
