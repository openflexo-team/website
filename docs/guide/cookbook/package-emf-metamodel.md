---
sidebar_position: 5
title: Package an EMF metamodel
---

# Import an EMF Metamodel in Openflexo

In this tutorial you will learn how to import an EMF metamodel stored as an ecore file into Openflexo. Before you start, see [Get started](/docs/get-started/) to install Openflexo. The prerequisites are:

:::note
The two downloadable inputs this page originally linked (`universe.ecore` and `emf.properties`)
were served by the project's old TikiWiki site and are gone — tracked as `WEB-D-1`. The steps below
are otherwise unchanged and apply to any ecore metamodel of your own.
:::
