...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/excel_model.png" alt="Excel Model" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/overview.png" alt="Overview" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/excel_ta.png" alt="Excel TA Perspective" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/customers_file_0.png" alt="Excel Customer File 0" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_vp_popup.png" alt="VP Popup" /> <img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_vp_wizard.png" alt="VP Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_vm_popup.png" alt="VM Popup" />
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_vm_wizard.png" alt="VM Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_ms_popup.png" alt="MS Popup" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_ms_wizard.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_role_sheet_popup.png" alt="Role Sheet popup" />
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_role_sheet_wizard.png" alt="Role Sheet wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/action_get_set_popup.png" alt="Get Set Popup" />
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/action_setcustomersheet.png" alt="Set customersheet" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_fc_wizard.png" alt="FC wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_fc_role_popup.png" alt="FCRole popup" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_fc_role_wizard.png" alt="FCRole  wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_bp_popup.png" alt="Create BP popup" />

Select the type of parameter, in our case this is an __Excel row__ , and set its name for instance __row_parameter__ .
 
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/set_row_parameter.png" alt="Set row parameter" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/set_row_parameter_2.png" alt="Set row parameter" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/new_customer_wizard.png" alt="New Customer wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/new_customer_wizard_2.png" alt="New Customer wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/vm_add_customer_1.png" alt="Add customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/vm_add_customer_2.png" alt="Add customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/vm_add_customer_3.png" alt="Add customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/retrieve_customer_1.png" alt="Retrieve customer" />
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/retrieve_customer_2.png" alt="Retrieve customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/retrieve_customer_3.png" alt="Retrieve customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/retrieve_customer_5.png" alt="Retrieve customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_view_1.png" alt="Retrieve customer" />

Give a name and select its viewpoint(here TutoExcel) and set the __configure all model slot manually__ , then __Finish__ .

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_view_2.png" alt="Retrieve customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_view_3.png" alt="Retrieve customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_vmi_1.png" alt="Retrieve customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_vmi_2.png" alt="Retrieve customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/vmi_part_1.png" alt="Retrieve customer" />

Now try to add a new Customer, to do that right click on the __Virtual model instance__ and __AddNewCustomer__.

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/vmi_part_1_2.png" alt="Retrieve customer" />

Fill the different informations, and finish.

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/vmi_part_1_3.png" alt="Retrieve customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/vmi_part_1_4.png" alt="Retrieve customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_ms_popup.png" alt="MS Popup" /> 
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_ms_wizard_2.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/companies_sheet_property.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_company_concept.png" alt="Retrieve customer" />
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/company_roles_2.png" alt="Retrieve customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_company_customers_1.png" alt="Retrieve customer" />

When finish, select it and change the type of Flexo Concept to Customer.

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_company_customers_2.png" alt="Retrieve customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/new_expression_property.png" alt="Retrieve customer" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_bp_popup.png" alt="MS Wizard" />

Create an AddExcelCell action. Its role is to instanciate a new cell in a specified workbook.

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/create_company_1.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/update_companies_scheme.png" alt="MS Wizard" />

Inside create a new __Iteration action__ to browser over all current Customers.

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/update_companies_scheme_1.png" alt="MS Wizard" />

Select the __Iteration Action__ and select (+) > __Add action inside iteration__.

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/add_comp_1.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/add_comp_c.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/add_comp_d.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/add_comp_e.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/part3_view_2.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/part3_view_3.png" alt="MS Wizard" />

Now save the companies Excel file:

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/part3_view_4.png" alt="MS Wizard" />

And open it from the __Infomation Space__ or from you file system:

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/part3_view_5.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/change_row_style_1.png" alt="MS Wizard" />

Give a name and provide a parameter which is a Customer (Flexo Concept).

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/change_row_style_2.png" alt="MS Wizard" />

Give a name to the parameter like for instance __customer__.

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/change_row_style_3.png" alt="MS Wizard" />

Then you have to create two __CellStyleAction__ , the first one sets the style to a Solid Foreground:

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/change_row_style_5.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/change_row_style_6.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/change_row_style_7.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/change_cell_style_1.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/change_cell_style_2.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/change_cell_style_3.png" alt="MS Wizard" />

Create 2 __CellStyleAction__ on the cell to modify its style:

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/change_cell_style_4.png" alt="MS Wizard" />
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/change_cell_style_5.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/change_cell_style_6.png" alt="MS Wizard" />
...
<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/formula_1.png" alt="MS Wizard" />

Test the action in the __View Editor__, and check you see the average salary in you Excel sheet.

<img src="/images/tutorials/Tutorial5-FederatingExcelDocuments/formula_2.png" alt="MS Wizard" />
